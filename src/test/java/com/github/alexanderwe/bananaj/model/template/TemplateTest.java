...
public class TemplateTest {
	...
	public void testTemplate() throws Exception {
		...
		assertEquals(template.getId(), 123413);
		assertEquals(template.getName(), "Test Template");
		assertEquals(template.getCategory(), "");
		assertEquals(template.getFolderId(), "11223a6040");
		assertEquals(template.getCreatedBy(), "Sue Smith");
		assertEquals(template.getEditedBy(), "John Tester");
