...
import com.github.alexanderwe.bananaj.model.automation.emails.AutomationSubscriberQueue;
...
public class AutomationTest {
	...
	public void testAutomation() {
		...
		assertEquals(automation.getId(), "2f522d1363");
		assertNull("Not started", automation.getStartTime());
		assertEquals(automation.getEmailsSent(), 0);
		assertEquals(automation.getStatus(), AutomationStatus.SAVE);
		assertEquals(automation.getRecipients().getListId(), "a70b3a068a");
		assertEquals(automation.getSettings().getFromName(), "Analytics Robot");
		//automation.toString();
	}
	...
	public void testAutomationEmail() {
		...
		assertEquals(autoObj.getId(), "3fbba32116");
		assertNull("Not started", autoObj.getStartTime());
		assertEquals(autoObj.getEmailsSent(), 0);
		assertEquals(autoObj.getStatus(), AutomationStatus.SAVE);
		assertEquals(autoObj.getRecipients().getListId(), "a70b3a068a");
		assertEquals(autoObj.getRecipients().getSegmentOpts().getMatch(), MatchType.ANY);
		assertEquals(autoObj.getSettings().getFromName(), "Analytics Robot");
		autoObj.toString();
	}
...
//		assertEquals(autoObj.getId(), "2f522d1363");
//	}
