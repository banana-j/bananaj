...
//	}
	...
	@Test
	public void testCampaign_Feedback() {
		JSONObject jsonObj = new JSONObject("{\"feedback_id\":27169,\"parent_id\":0,\"block_id\":0,\"message\":\"This is a test comment\",\"is_complete\":false,\"created_by\":\"John Smith\",\"created_at\":\"2020-04-10T20:39:04+00:00\",\"updated_at\":\"2020-04-10T20:39:05+00:00\",\"source\":\"web\",\"campaign_id\":\"42694e9e57\",\"_links\":[{\"rel\":\"self\",\"href\":\"https://us3.api.mailchimp.com/3.0/campaigns/42694e9e57/feedback/27169\",\"method\":\"GET\",\"targetSchema\":\"https://us3.api.mailchimp.com/schema/3.0/Definitions/Campaigns/Feedback/Response.json\"},{\"rel\":\"parent\",\"href\":\"https://us3.api.mailchimp.com/3.0/campaigns/42694e9e57/feedback\",\"method\":\"GET\",\"targetSchema\":\"https://us3.api.mailchimp.com/schema/3.0/Definitions/Campaigns/Feedback/CollectionResponse.json\"},{\"rel\":\"update\",\"href\":\"https://us3.api.mailchimp.com/3.0/campaigns/42694e9e57/feedback/27169\",\"method\":\"PATCH\",\"targetSchema\":\"https://us3.api.mailchimp.com/schema/3.0/Definitions/Campaigns/Feedback/PATCH.json\",\"schema\":\"https://us3.api.mailchimp.com/schema/3.0/Definitions/Campaigns/Feedback/Response.json\"},{\"rel\":\"delete\",\"href\":\"https://us3.api.mailchimp.com/3.0/campaigns/42694e9e57/feedback/27169\",\"method\":\"DELETE\"}]}],\"campaign_id\":\"42694e9e57\",\"total_items\":1,\"_links\":[{\"rel\":\"parent\",\"href\":\"https://us3.api.mailchimp.com/3.0/campaigns/42694e9e57\",\"method\":\"GET\",\"targetSchema\":\"https://us3.api.mailchimp.com/schema/3.0/Definitions/Campaigns/Response.json\"},{\"rel\":\"self\",\"href\":\"https://us3.api.mailchimp.com/3.0/campaigns/42694e9e57/feedback\",\"method\":\"GET\",\"targetSchema\":\"https://us3.api.mailchimp.com/schema/3.0/Definitions/Campaigns/Feedback/CollectionResponse.json\"},{\"rel\":\"create\",\"href\":\"https://us3.api.mailchimp.com/3.0/campaigns/42694e9e57/feedback\",\"method\":\"POST\",\"targetSchema\":\"https://us3.api.mailchimp.com/schema/3.0/Definitions/Campaigns/Feedback/Response.json\",\"schema\":\"https://us3.api.mailchimp.com/schema/3.0/Definitions/Campaigns/Feedback/POST.json\"}");
		CampaignFeedback feedback = new CampaignFeedback(null, jsonObj);
		assertEquals(false, feedback.getIsComplete());
		assertEquals(27169, feedback.getFeedbackId().intValue());
		assertEquals(0, feedback.getParentId().intValue());
		assertEquals(0, feedback.getBlockId().intValue());
		assertEquals("This is a test comment", feedback.getMessage());
	}
